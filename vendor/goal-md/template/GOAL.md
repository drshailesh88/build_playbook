<!--
VENDORED REFERENCE — upstream template from goal-md.
The /improve command adapts this: GOAL.md lives at .quality/goals/GOAL.md,
iteration logs at .quality/goals/iterations-<metric>-active.jsonl.
Do NOT edit this file — modify commands/improve.md instead.
-->
<!--
